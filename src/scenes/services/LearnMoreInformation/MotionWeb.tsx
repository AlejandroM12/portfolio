...
const MotionWeb = ({ isOpen, onClose }: Props) => {

    
  return (
    <LearnMore onClose={onClose}>
        <div className="relative h-[450px] mb-[20px] bg-[#efefef] rounded-md overflow-hidden max-h-[450px]">
            <div className="absolute top-0 bottom-0 left-0 right-0 bg-no-repeat bg-center bg-cover bg-services-1"></div>
        </div>
        <div>
            <h3 className="text-1xl text-[#0f172a] font-bold mb-[15px]">Motion & Web Graphy Breakdown In Cinema 4D</h3>
            ...
            <h3 className="text-1xl text-[#0f172a] font-bold mb-[15px]">What Is Motion & Web?</h3>
            <p className="mb-[30px] text-base font-normal">Nullam blandit constituto eam ne, te nam ignota vituper.atoribus. Malis cetero quem saipe, prou thendrerit voluptaria.</p>
                <div className="w-full mb-[30px] pl-[20px]">
                    <ul className="m-0">
                        ...
                        <li className="mx-0 mt-0 mb-[15px] relative pl-[20px] w-full">
                            <p className="mb-0 text-base before:absolute before:content-[''] before:w-[5px] before:h-[5px] before:rounded-full before:bg-gray-200 before:left-0 backdrop:top-[13px]">Whether you’re kicking off a new ca mpaign.</p>
                        </li>
                        <li className="mx-0 mt-0 mb-[15px] relative pl-[20px] w-full">
                            <p className="mb-0 text-base before:absolute before:content-[''] before:w-[5px] before:h-[5px] before:rounded-full before:bg-gray-200 before:left-0 backdrop:top-[13px]">Habitasse per feugiat aliquam luctus accumsan curae</p>
                        </li>
                    </ul>
                        </div>
