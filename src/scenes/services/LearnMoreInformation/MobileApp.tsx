...
const MobileApp = ({ isOpen, onClose }: Props) => {
  return (
    <LearnMore onClose={onClose}>
        <div className="relative h-[450px] mb-[20px] bg-[#efefef] rounded-md overflow-hidden max-h-[450px]">
            <div className="absolute top-0 bottom-0 left-0 right-0 bg-no-repeat bg-center bg-cover bg-services-4"></div>
        </div>
        <div>
            <h3 className="text-1xl text-[#0f172a] font-bold mb-[15px]">Mobile App Design is the trending Part of Graphics</h3>
            ...
            <h3 className="text-1xl text-[#0f172a] font-bold mb-[15px]">What Is Mobile App Design?</h3>
